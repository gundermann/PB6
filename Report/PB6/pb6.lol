\contentsline {lstlisting}{\numberline {1}Kommentare mit '\#' als Terminale}{8}{lstlisting.1}
\contentsline {lstlisting}{\numberline {2}Terminale f\"ur Wirkungen}{8}{lstlisting.2}
\contentsline {lstlisting}{\numberline {3}Validierung der Deklaration von Pr\"ufungs-IDs f\"ur die Zuweisung zu Antr\"agen}{11}{lstlisting.3}
\contentsline {lstlisting}{\numberline {4}Validierung der Verwendung von deklarierten Pr\"ufungs-IDs}{12}{lstlisting.4}
\contentsline {lstlisting}{\numberline {5}Validierung der durchg\"angig laufenden}{13}{lstlisting.5}
